...
src/ <br>
├── components/ # Componentes reutilizáveis (Input, Button, Flag...) <br>
├── config/ # Configurações de API e Firebase <br>
├── context/ # Gerenciamento de Estado Global (Auth e List) <br>
├── global/ # Tokens de Design (Cores, Fontes, Métricas) <br>
├── pages/ # Telas da aplicação (Login, List, User...) <br>
├── routes/ # Configuração de Navegação (Stack e Tabs) <br>
